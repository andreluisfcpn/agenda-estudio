...
// (VITE_GOOGLE_CLIENT_ID). Sem ele, o botão quebraria — então é ocultado.
const GOOGLE_ENABLED = !!(import.meta as any).env?.VITE_GOOGLE_CLIENT_ID;
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            if (view === 'forgot_password') {
                ...
                // Não há reset de senha por link (sem endpoint dedicado). Em vez de fingir envio,
                // usamos o login por CÓDIGO (OTP real): enviamos um código ao e-mail; o usuário
                // entra sem a senha e pode redefini-la depois no perfil.
                try {
