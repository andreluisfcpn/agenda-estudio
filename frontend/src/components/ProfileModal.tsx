...
export default function ProfileModal({ isOpen = true, onClose, onSuccess }: ProfileModalProps) {
    ...
    return (
        <BottomSheetModal
            isOpen={isOpen}
            onClose={onClose}
            title={cropImageSrc ? '✂️ Ajustar Foto' : 'Meu Perfil'}
            preventClose={!!cropImageSrc || saving}
            maxWidth="540px"
        >
            {cropImageSrc ? (
                <ImageCropper
