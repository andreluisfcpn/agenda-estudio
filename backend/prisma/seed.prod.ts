...
async function main() {
  ...
  const configEntries = [
    ...
    { key: "gateway_stripe_fee_pct", value: "3.99", type: "percent", label: "Taxa Stripe (%)", group: "gateway" },
    { key: "gateway_stripe_fee_cents", value: "39", type: "number", label: "Taxa Fixa Stripe por Transação (centavos)", group: "gateway" },
